...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionChercherRef = QAction(MainWindow)
        self.actionChercherRef.setObjectName(u"actionChercherReference")
        ...
        icon5 = QIcon()
        icon5.addFile(u":/images/logo.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/images/switch.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.Selectionneur_Voies = QAction(MainWindow)
        self.Selectionneur_Voies.setObjectName(u"Selectionneur_Voies")
        icon7 = QIcon()
        icon7.addFile(u":/images/selectionneurVoies.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.Selectionneur_Voies.setIcon(icon7)
        self.actionChercherRef = QAction(MainWindow)
        self.actionChercherRef.setObjectName(u"actionChercherRef")
        ...
        self.comboBox_nbTours.setEditable(False)
        ...
        self.sendButton_lancementTestNuit.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.sendButton_activer_filtrage.setCursor(QCursor(Qt.CursorShape.CrossCursor))
        ...
        self.sendButton_reglage_nb_etat_en_test.setCursor(QCursor(Qt.CursorShape.CrossCursor))
        ...
        self.mainToolBar.addSeparator()
        self.mainToolBar.addAction(self.Selectionneur_Voies)
        self.mainToolBar.addSeparator()
        self.mainToolBar.addAction(self.actionChercherRef)
        ...
        self.menuApplications.addAction(self.actionFicheValidation)
        self.menuApplications.addAction(self.actionHistorique)
        self.menuApplications.addAction(self.Selectionneur_Voies)
        self.menuApplications.addAction(self.actionChercherRef)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionChercherRef.setText(QCoreApplication.translate("MainWindow", u"&Chercher Référence", None))
...
#endif // QT_CONFIG(tooltip)
        self.Selectionneur_Voies.setText(QCoreApplication.translate("MainWindow", u"&Selectionneur Voies", None))
#if QT_CONFIG(tooltip)
        self.Selectionneur_Voies.setToolTip(QCoreApplication.translate("MainWindow", u"Selectionneur Voies", None))
#endif // QT_CONFIG(tooltip)
        self.actionChercherRef.setText(QCoreApplication.translate("MainWindow", u"&Chercher R\u00e9f\u00e9rence", None))
#if QT_CONFIG(tooltip)
        self.actionChercherRef.setToolTip(QCoreApplication.translate("MainWindow", u"Chercher R\u00e9f\u00e9rence", None))
#endif // QT_CONFIG(tooltip)
